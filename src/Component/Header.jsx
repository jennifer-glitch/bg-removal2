...
function Header() {
  return (
    ...
    <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum is simply a dummy text of the printing and typesetting industry. <br className='max-sm:hidden' /> lorem ipsum has been the industry's standard dummy text ever </p>
      <div className="">
